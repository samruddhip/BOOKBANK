...
return 0;
    ...
    {
        printf("    1.Only KIT Students, Researchers, Faculty and Staff as registered members are allowed to use the Central Library.\n\n");
        printf("    2.Members should produce their Library Membership card at the entrance of the Library.\n\n");
        printf("    3.A duplicate Library Membership card will be issued on payment of Rs.100/-.\n\n");
        printf("    4.The ex-faculty/staff members may be enrolled as members against a security deposit of Rs. 5000/- (refundable) and registration fee of Rs. 1000/- (non-refundable).\n\n");
        printf("    5.Some �eminent academicians/scholars and other dignitaries may be enrolled as Special members on the recommendations of the Vice-Chancellor, KIT only against a security deposit of Rs. 5000/- (refundable) and registration fee of Rs. 1000/- (non-refundable).\n\n");
        printf("\n\n");
        printf("GO TO MAIN MENU PRESS 1 ==> ");
    ...
    void student()
    {
      int result,result1,x,j;
      char str1[10],str2[10];
      char username[10]="sam", password[10]="01";
        printf("ENTER USERNAME : ");
       scanf("%s",&str1);
       printf("ENTER PASSWORD : ");
       scanf("%s",&str2);
       result=strcmp(username,str1);
       result1=strcmp(password,str2);
...
gotoxy(20,7);
printf("\xDB\xDB\xDB\xDB\xB2  2. Issue Books");
gotoxy(20,9);
...
void librarian()
    {  int o;
       int Lresult,Lresult1,x,j;
       char Lstr1[10],Lstr2[10];
       char Lusername[10]="sam", Lpassword[10]="01";
        printf("ENTER USERNAME : ");
       scanf("%s",&Lstr1);
       printf("ENTER PASSWORD : ");
       scanf("%s",&Lstr2);
       Lresult=strcmp(Lusername,Lstr1);
       Lresult1=strcmp(Lpassword,Lstr2);

       if(Lresult==0 && Lresult1==0)
        {printf("\n LOGIN SUCCESSFULLY \n");
         system("cls");
